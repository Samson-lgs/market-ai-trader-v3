...
Walk-forward historical validation using the same MTF analysis and setup detector. Decisions use only candles available at the decision timestamp; future candles are used only for outcome evaluation.

Metrics: trades, win rate, net R, expectancy, profit factor, maximum drawdown, loss streak, and setup grade/type breakdowns.
